export const accessories = [
    ...
    
    {
        ...
        defaultColor: "silver",
        Title: "Adjustable Aluminum Laptop Stand With Cooling Fan (10″ to 17″)",
        ...
        description: "A sturdy aluminum laptop stand with built-in dual-core cooling fans, adjustable angles, and a foldable design for easy portability. Suitable for laptops from 10″ to 17″.",
        ...
        topSpecs: [
            ...
            "<h6><span>COMPATIBILITY</span><span class='detail-specs-h6'>Supports laptops from 10″ to 17″</span></h6>",
        ...
        detailSpecs: [
            "<h6><span>STURDY & STABLE</span><span> — Made of durable aluminum alloy for maximum device protection</span></h6>",
            "<h6><span>ADJUSTABLE ANGLE</span><span> — Z-type design for ideal height adjustment</span></h6>",
            "<h6><span>DUAL-CORE COOLING</span><span> — Built-in fans for enhanced heat dissipation</span></h6>",
            "<h6><span>PORTABLE & MULTI-USE</span><span> — Suitable for laptops, tablets, projectors, and books</span></h6>",
            "<h6><span>ERGONOMIC DESIGN</span><span> — Reduces muscle strain with improved posture support</span></h6>"
        ],
        tags: [
            "laptop-stand",
            "cooling-stand",
    ...
    //------------- Handheld Accesories
    {
        ...
        detailSpecs: [
            "<h6><span>COMPATIBILITY</span><span> — Nintendo Switch</span></h6>",
            "<h6><span>BUTTONS</span><span> — Right Joy-Con: A, B, X, Y, R, ZR, SL, SR, Home, Release, Sync | Left Joy-Con: L, ZL, SL, SR, Capture, Release, Sync</span></h6>",
            "<h6><span>CONNECTIVITY</span><span> — Bluetooth 3.0, NFC</span></h6>",
            "<h6><span>MOTION CONTROLS</span><span> — Right Joy-Con: Accelerometer, Gyroscope, IR Motion Camera | Left Joy-Con: Accelerometer, Gyroscope</span></h6>",
            "<h6><span>VIBRATION</span><span> — HD Rumble</span></h6>",
            "<h6><span>BATTERY LIFE</span><span> — Up to 20 hours</span></h6>",
            "<h6><span>CHARGING TIME</span><span> — About 3.5 hours</span></h6>",
            "<h6><span>WEIGHT</span><span> — Left: 51.03g, Right: 48.18g</span></h6>",
            "<h6><span>DIMENSIONS</span><span> — 4.1 x 6.8 x 2.12 inches</span></h6>",
            "<h6><span>COLOR OPTIONS</span><span> — Gray, Neon Red & Neon Blue</span></h6>"
        ],
        tags: [
            "nintendo-switch",
            "joy-con",
